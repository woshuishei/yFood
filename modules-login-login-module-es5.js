...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-login-login-module"], {
  ...
  /***/
  function node_modules_rawLoader310RawLoaderDistCjsJsSrcAppModulesLoginLoginComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppModulesLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      ...
      function LoginComponent(ser, rou) {
        _classCallCheck(this, LoginComponent);

        this.ser = ser;
        this.rou = rou; // 以下aaa对象是要在post请求中用到的
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.ser.postData(this.account).subscribe(function (res) {
            console.log(res);

            if (res.code == 0) {
              window.sessionStorage.setItem('auth_token', _this.account.name);

              _this.rou.navigate(['/page']);
            } else {
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/_raw-loader@3.1.0@raw-loader/dist/cjs.js!./src/app/modules/login/login.component.html"))["default"],
  ...
  function srcAppModulesLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LoginModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _login_routing_module__WEBPACK_IMPORTED_MODULE_3__["LoginRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]]
    })], LoginModule);
    /***/
  }
}]);
